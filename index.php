    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/banners/prueba.jpg" alt="Imagen 1"
            ...
            <div class="carousel-item">
                <img src="images/banners/slidehome.webp" alt="Imagen 2"
                    style="width: 100%; max-height: 500px; object-fit: cover;">
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img src="images/banners/cocina.jpg" alt="Imagen 3"
                    style="width: 100%; max-height: 500px; object-fit: cover;">
                <div class="carousel-caption">
        ...
        <div class="container">
            ...
            <div class="hm-grid-category">
                ...
                <div class="grid-item" data-aos="fade-up" data-aos-duration="1000">
                    <a href="#">
                        <img src="images/Pisos laminados/piso laminado Harbour Oak Grey.png" alt="">
                        <div class="c-info">
                ...
                <div class="grid-item" data-aos="fade-up" data-aos-duration="1500">
                    <a href="#">
                        <img src="images/Pisos PVC/pisos.png" alt="">
                        <div class="c-info">
                            <h3>Pisos PVC</h3>
                        </div>
                    </a>
                ...
                <div class="grid-item" data-aos="fade-up" data-aos-duration="2000">
                    <a href="productos.php#seccion-destino3">
                        <img src="images/techos/techo_pvc_.jpeg" alt="">
                        <div class="c-info">
                            <h3>Techos </h3>
                        </div>
                    </a>
